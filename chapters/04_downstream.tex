  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.50\textwidth}
      ...
      \begin{itemize}\setlength\itemsep{1pt}
        ...
        \item \texttt{on\_configure} — create a private ROS node and spawn the \emph{comm thread}.
        \item \texttt{export\_state/command\_interfaces} — hand back pointers to \texttt{hw\_positions\_}, \texttt{hw\_velocities\_}, \texttt{hw\_commands\_}.
        \item \texttt{read} / \texttt{write} — the RT clock of the control side (next two slides).
      \end{itemize}
